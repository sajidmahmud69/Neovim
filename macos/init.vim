...
set showcmd                     " how me what I'm typing
...
" Set fontsize and change it with command+ plus/minus 
let s:fontsize = 12
...
"In normal mode use command+ plus/minus to increase or decrease font size
noremap <C-Plus> :call AdjustFontSize (1)<CR>
noremap <C-Minus> :call AdjustFontSize (-1)<CR>
" In Insert mode use command + plus/minus to increase or decrease font size
inoremap <C-Plus> <ESC>:call AdjustFontSize (1)<CR>a
inoremap <C-Minus> <ESC>:call AdjustFontSize (-1)<CR>aS
